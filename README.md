...
1. Create a Direct Upload Pages project named `affordi` with production branch `main`: `npx --yes wrangler@4.131.1 pages project create affordi --production-branch main`.
